...
//! [`ir::FunctionIr`] and get everything else; see `vikt-jvm` (JVM bytecode
//! via mokapot) and `vikt-py` (CPython bytecode). Because
...
//!
//! ```
//! use vikt_core::ir::{FunctionId, FunctionIr, Node, NodeKind};
//! use vikt_core::{Denylist, ScoreWeights, Tier, analyze};
//!

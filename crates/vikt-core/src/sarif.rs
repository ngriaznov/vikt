...
pub struct SarifResult {
    /// The tier's rule, e.g. `vikt/core`.
    pub rule_id: String,
    /// Always `note`: vikt describes code, it does not diagnose defects,

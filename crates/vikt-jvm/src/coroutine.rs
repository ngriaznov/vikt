...
use vikt_core::ir::{Node, NodeKind};
...
mod tests {
    ...
    fn pruning_restores_the_natural_loop() {
        ...
        let before = vikt_core::Graph::build(&vikt_core::ir::FunctionIr {
            id: vikt_core::ir::FunctionId {
                file: "T.kt".into(),
                name: "t".into(),
        ...
        let after = vikt_core::Graph::build(&vikt_core::ir::FunctionIr {
            id: vikt_core::ir::FunctionId {
                file: "T.kt".into(),
                name: "t".into(),
                signature: String::new(),
